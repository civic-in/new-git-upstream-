 ...
 *
 * On another hand, AAM Object is a âcontainerâ with specific settings for any user,
...
abstract class AAM_Core_Object
{
     ...
     *
     * FacadÄ that combines explicit options update and persisting them in DB
     *
     * @param string $item
     * @param mixed  $value
     *
